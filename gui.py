...
import threading
from trainer import ZTrainer

class ZGUI:
    def __init__(self):
        self.trainer = ZTrainer()
        self.root = tk.Tk()
        self.root.title("Hades II Trainer Max 1.0.0")
    ...
    def build_ui(self):
        header = tk.Label(self.root, text="HADES II TRAINER MAX", bg="#1a1a2e", fg="#d34061",
